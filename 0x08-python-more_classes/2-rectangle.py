#!/usr/bin/python3
class Rectangle:
    """Represents a rectangle with width, height, area, and perimeter calculations."""

    def __init__(self, width=0, height=0):
        """Initializes a Rectangle with optional width and height (default 0) ."""
        self.width = width
        self.height = height
    ...
    def perimeter(self):
        """Calculates and returns the perimeter of the rectangle. Account for zero values."""
